            ...
            <div class="info justify-between">
                ...
                <div class="align-center gap10">
                    ...
                    <div class="action-menu-wrapper">
                        <svg onclick="toggleMenu(this)" xmlns="http://www.w3.org/2000/svg" height="24px"
                            viewBox="0 -960 960 960" width="24px" fill="#292D32" style="cursor: pointer;">
                            <path
...
function toggleMenu(button) {
    const menu = button.parentElement.querySelector('.popup-menu');
    const allMenus = document.querySelectorAll('.popup-menu');

    // Sluit andere openstaande menus
    allMenus.forEach(m => {
...
document.addEventListener('click', function(e) {
    const isMenu = e.target.closest('.action-menu-wrapper');
    if (!isMenu) {
